...
const Cheep = ({ openCheep, setOpenCheep }) => {
	...
	return (
		<div className="cheep">
			<div className="cheep__content" onClick={() => setOpenCheep((prev) => !prev)}>
			...
			<dl
				className={openCheep ? 'cheep__modal _active modal-mini' : 'cheep__modal modal-mini'}>
				<dt onClick={() => onValue('alphabet')}>По алфавиту</dt>
				<dt>По цене</dt>
				<dd onClick={() => onValue('price-min')}>max-min</dd>
				<dd onClick={() => onValue('price-max')}>min-max</dd>
				<dt onClick={() => onValue('cls')}>Сброс</dt>
			</dl>
		</div>
	)
}
